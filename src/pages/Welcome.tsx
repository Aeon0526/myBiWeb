...
const blockContent = `通过我们的教学数据智能分析系统，即使对数据分析一无所知的同学也能够轻松完成复杂的数据分析任务，大幅节约人力成本。利用AI接口和自动化技术，我们为您提供了快速、准确和可靠的数据洞察力。立即体验我们的智能BI平台，让数据分析变得简单而智能！`;
const BIIntroduce = `这是一个创新的数据分析工具，与传统的方式完全不同。我们的项目利用AI技术，以完全新颖的方式帮助用户进行数据分析，节约人力成本并提高效率。
...
const Welcome: React.FC = () => {
  ...
  return (
    <PageContainer content={' 欢迎来到教学数据智能分析系统'}>
      <Card>
        <Alert
          message={'欢迎使用教学数据智能分析！'}
          type="success"
          showIcon
          banner
          style={{
        ...
        >
          <SmileTwoTone style={{ color: '#0015ff' }} /> 教学数据智能分析系统{' '}
        ...
        <Paragraph strong style={{ color: '#0067ff' }}>
          1.
          自动化数据分析：项目采用AI技术，能够自动化地从原始数据中生成符合要求的图表和分析结论。只需要输入分析目标和原始数据，无需具备专业的数据分析知识，即可完成数据分析的过程。
        </Paragraph>
        <Paragraph strong style={{ color: '#00bbff' }}>
          2.
          节约人力成本：传统的数据分析通常需要教师具备一定的技能和经验，并花费大量的时间进行数据清洗、转化和分析。这个项目的优势在于能够大幅度降低人工数据分析成本，让不具备数据分析能力的用户也能迅速完成数据分析任务，节约了人力资源。
        </Paragraph>
