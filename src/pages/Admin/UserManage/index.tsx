...
import { selectUserRole } from '@/constants';
import {
  deleteUserUsingPost,
  ...
  },
  {
    ...
    render: (text, record, _, action) => [
      <ModalForm<API.User>
        ...
        submitTimeout={500}
        onFinish={async (values: { id: number }) => {
          await waitTime(500);
          //点击了提交，发起请求
          values.id = record.id;
      ...
      >
        <ProForm.Group>
          ...
          />
          <ProForm.Item label={'用户头像'} name={'userAvatar'}>
            <FileUploader biz={'user_avatar'}>上传图片</FileUploader>
          </ProForm.Item>
        </ProForm.Group>
      </ModalForm>,
      <a key="view">
